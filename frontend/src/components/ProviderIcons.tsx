...
export function CalendarIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#4285F4" strokeWidth="1.8" aria-hidden="true">
...
export function MeetIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path d="M15 10l6-3.5v11L15 14z" fill="#00897B" />
    </svg>
  );
}
...
export function MailIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#EA4335" strokeWidth="1.8" aria-hidden="true">
