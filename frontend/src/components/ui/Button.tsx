...
/** Exported so a caller that genuinely needs a button-shaped element outside
 *  `<Button>` itself - Overflow's labelled triggers are the one case - can
 *  compose the exact same box rather than hand-copying these strings and
 *  drifting from them the next time padding or radius changes here. */
